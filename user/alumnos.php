...
<body class="layout-default">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="px-3">
                        ...
                        <form action="#" class="was-validated" id="registrar_alumno_form">
                            <div class="form-group">
                                <label for="nombre">Nombre:</label>
                                <input class="form-control" type="text" name="nombre" required="" placeholder="Nombre estudiante" />
                            </div>
                            <div class="form-group">
                                <label for="apellido">Apellido:</label>
                                <input class="form-control" type="text" name="apellido" required="" placeholder="Apellido estudiante" />
                            </div>
                            <div class="form-group">
                                <label for="edad">Edad:</label>
                                <input class="form-control" type="number" name="edad" required="" placeholder="edad estudiante" />
                            </div>
                            <div class="form-group">
                                <label for="correo">Correo:</label>
                                <input class="form-control" type="email" name="correo"  placeholder="sede@doe.com" />
                            </div>
                            <div class="form-group">
                                <label for="direccion">Dirección:</label>
                                <input class="form-control" type="text" name="direccion"  placeholder="carrera 1 # 2-29" />
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="px-3">
                        ...
                        <form action="#" class="was-validated" id="editar_alumno_form">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    <div class="px-3">
                        ...
                        <button type="button" class="btn btn-danger" onclick="eliminar_alumno()">Eliminar</button>
    ...
    <script src="js/alumnos/peticion_alumnos.js"></script>
