...
foreach ($datos as $row) { ?>
    ...
    <tr>
        ...
        <td>
            <button type="button" class="btn btn-warning" onclick="show_institucion(<?php echo $row['id']; ?>)"><i class="fa fa-pen"></i></button>
            <button type="button" class="btn btn-danger" onclick="delete_institucion(<?php echo $row['id']; ?>, '<?php echo $row['nombre']; ?>')"><i class="fa fa-trash"></i></button>
        </td>
    </tr>
