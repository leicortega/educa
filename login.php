    ...
    <div class="layout-login-centered-boxed__form mt-5">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-2 navbar-light">
            <a href="index.html" class="navbar-brand text-center mb-2 mr-0" style="min-width: 0">
                ...
                <span class="ml-2">Educa</span>
            </a>
        </div>

        <div class="card card-body">

            <form action="assets/php/validaciones/validar_login.php" method="POST">
                <div class="form-group">
                    <label class="text-label" for="email_2">Identificación:</label>
                    <div class="input-group input-group-merge">
                        <input id="email_2" name="identificacion" type="number" required class="form-control form-control-prepended" placeholder="Escriba la identificacion">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="password_2" name="password" type="password" required class="form-control form-control-prepended" placeholder="Escriba la contraseña">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                ...
                <div class="form-group">
                    <button class="btn btn-block btn-primary" type="submit">Iniciar sesion</button>
                </div>
